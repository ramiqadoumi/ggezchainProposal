...
func (app *App) setupUpgradeHandlers(configurator module.Configurator) {
	...
	app.UpgradeKeeper.SetUpgradeHandler(
		...
		func(ctx sdk.Context, plan upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
			...
			fromVM[mobilemoduletypes.ModuleName] = mobile.ConsensusVersion()
			mobileParams := mobilemoduletypes.Params{}
			genState := 
			mobileModule(ctx, mobileParams, genState)
	...
	case V2.UpgradeName:
		storeUpgrades = &storetypes.StoreUpgrades{
			Added: []string{"feesplit",mobilemoduletypes.StoreKey,trademoduletypes.StoreKey},
		}
