...
export const TradeIndex = {
  encode(message: TradeIndex, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.nextId !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): TradeIndex {
  ...
  fromJSON(object: any): TradeIndex {
    return { nextId: isSet(object.nextId) ? Number(object.nextId) : 0 };
  },

  toJSON(message: TradeIndex): unknown {
    const obj: any = {};
    message.nextId !== undefined && (obj.nextId = Math.round(message.nextId));
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<TradeIndex>, I>>(object: I): TradeIndex {
    const message = createBaseTradeIndex();
