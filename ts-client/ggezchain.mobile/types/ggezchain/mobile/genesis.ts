...
/** GenesisState defines the mobile module's genesis state. */
...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, mobileIndex: undefined, storedTradeList: [] };
}
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.mobileIndex !== undefined) {
      MobileIndex.encode(message.mobileIndex, writer.uint32(18).fork()).ldelim();
    }
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      mobileIndex: isSet(object.mobileIndex) ? MobileIndex.fromJSON(object.mobileIndex) : undefined,
